...
const ForgotPassword = () => {
  ...
  return (
    <>
      ...
      <h1 className="text-sky-600 font-black text-lg md:text-2xl lg:text-6xl capitalize">Recupera tu acceso y no pierdas tus {''}<span className="text-slate-700">proyectos</span></h1>

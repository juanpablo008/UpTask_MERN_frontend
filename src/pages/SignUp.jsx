...
const SignUp = () => {
  ...
  return (
    <>
      <h1 className="text-sky-600 font-black text-2xl md:text-4xl lg:text-6xl capitalize">Crea tu cuenta y administra tus {''}<span className="text-slate-700">proyectos</span></h1>

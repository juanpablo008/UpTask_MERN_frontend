...
const NewPassword = () => {
  ...
  return (
    <>
      <h1 className="text-sky-600 font-black text-lg md:text-2xl lg:text-6xl capitalize">Reestablece tu contraseña y no pierdas acceso a tus {''}<span className="text-slate-700">proyectos</span></h1>
      {validToken && (
